...
Some exemples :
- pig enemy deploying shield : 
  [![sound_dark](sound_dark_icon.png#gh-light-mode-only)![sound_light](sound_light_icon.png#gh-dark-mode-only)](https://mega.nz/file/EfA3jCyQ#vShNj7ocOngT-bYNi4JGowSxk7cZKNRZm8_wmcCYPIM)
- y
